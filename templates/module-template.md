...
Context from the parent `stage.md` that bounds this module's scope.
- **Stage hypothesis:** <what the stage validates — this module must contribute to it>
- **Stage constraints:** <constraints inherited from stage.md>
- **Mission kill condition:** <if this is true, the whole mission is dead>
